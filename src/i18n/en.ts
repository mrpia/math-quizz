...
export const en: Record<TranslationKey, string> = {
  ...
  'results.paperNotSaved': "This paper test isn't saved: it's just for practice.",
  ...
  'progress.recencyNote':
    'Recent mistakes count more than old ones: a pair you are getting right again drops down the list quickly. A right answer that was too slow (🐢) counts a little too.',
  ...
  'heatmap.mastered': 'got it',
  'heatmap.review': 'to review',
  'heatmap.unsure': 'not sure yet',
  'heatmap.tableComplete': '{n} times table done',
